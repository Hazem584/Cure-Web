...
const ProfileAvatar = ({ theme, setTheme }) => {
     ...
     const [logged, setlogged] = useState(localStorage.getItem("user") && localStorage.getItem("token"));
     ...
     const notifications = [
          ...
          },
          {
               ...
               details: "You have successfully booked your appointment with Dr. Emily Walker.",
               type: "completed",
               elpased: "1h",
          },
          {
               title: "Appointment Cancelled",
               details: "You have successfully cancelled your appointment with Dr. David Patel.",
               type: "canceled",
               elpased: "1h",
          },
     ];
