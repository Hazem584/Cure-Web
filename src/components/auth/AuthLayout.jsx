...
const AuthLayout = ({ children }) => {
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-dark-bgSurface relative">
...
<div className="fixed bottom-0 right-0 w-full h-screen pointer-events-none hidden lg:block">
  <svg
    className="absolute -end-32 bottom-0 w-auto h-full"
    width="797"
    height="852"
    viewBox="0 0 797 852"
    fill="none"
