...
const Footer = () => {
     return (
          <footer className="bg-[#05162C] text-white flex flex-col gap-7 px-5 sm:px-12 pb-5 pt-20">
               <div className="flex justify-between flex-col md:flex-row xl:justify-normal xl:gap-44">
                    ...
                    <div className="quick-links flex flex-wrap flex-col lg:flex-row gap-[3.125rem]">
                              ...
                              <div className="list flex flex-col gap-4 font-medium font-montserrat">
                                   ...
                                   <div className="li-item">
                                        <div className="flex gap-4">
                                             ...
                                             <div className="info flex flex-col gap-2">
                                                  <p>Address</p>
                                                  <span className="small-des w-[9.625rem]">
