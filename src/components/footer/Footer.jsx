      ...
      <div className="flex justify-between gap-3 flex-col lg:flex-row xl:justify-normal xl:gap-44">
        ...
        <div className="quick-links flex flex-wrap md:flex-nowrap lg:flex-row gap-[3.125rem]">
          <div className="flex flex-col gap-6">
            <h3 className="title font-[Georgia] text-xl">Customer</h3>
            <div className="list flex flex-col gap-4 font-medium font-montserrat">
              <Link to="/home">
                <div className="li-item">Home</div>
              </Link>
              <Link to="/doctors">
                <div className="li-item">Doctors</div>
              </Link>
              <Link to="/home">
                <div className="li-item">FAQs</div>
              </Link>
              <Link to="/contact-us">
                <div className="li-item">Contact Us</div>
              </Link>
            </div>
          </div>
          <div className="flex flex-col gap-6">
            <h3 className="title font-[Georgia] text-xl">Support</h3>
            <div className="list flex flex-col gap-4 font-medium font-montserrat">
              <Link to="/">
                <div className="li-item">Help Center</div>
              </Link>
              <Link to="/home">
                <div className="li-item">How it works</div>
              </Link>
              <Link to="/">
                <div className="li-item">Privacy Policy</div>
              </Link>
              <Link to="/">
                <div className="li-item">Terms & Conditions</div>
              </Link>
            </div>
          </div>
          <div className="flex flex-col gap-6">
            <h3 className="title font-[Georgia] text-xl">Contact Info</h3>
              ...
              <div className="li-item">
                <div className="flex gap-4">
                  ...
                  <div className="info flex flex-col gap-2">
                    <p>Phone</p>
                    <span className="small-des">080 707 555-321</span>
                  </div>
                </div>
              </div>
              <div className="li-item">
                <div className="flex gap-4">
                  ...
                  <div className="info flex flex-col gap-2">
                    <p>Email</p>
                    <span className="small-des">demo@example.com</span>
                  </div>
                </div>
              </div>
              <div className="li-item">
