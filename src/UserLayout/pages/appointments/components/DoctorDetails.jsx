...
const DoctorDetails = ({ doctor, loading, error }) => {
  ...
  const stats = [
    { label: "patients", value: patientsValue, icon: FaUserFriends },
    {
      label: "experience",
    ...
    },
    {
      label: "rating",
      value:
        typeof rating?.average === "number" ? rating.average.toFixed(1) : "N/A",
      icon: FaStar,
    },
    { label: "reviews", value: rating?.count ?? "N/A", icon: TiMessages },
  ];
